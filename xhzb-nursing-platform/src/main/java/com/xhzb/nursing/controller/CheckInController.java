...
public class CheckInController extends BaseController
{
    ...
    @GetMapping(value = "/{id}")
    @Operation(summary = "获取入住管理详细信息")
    public AjaxResult getInfo(@Schema(name = "入住管理ID", requiredMode = Schema.RequiredMode.REQUIRED)
	...
	@DeleteMapping("/{ids}")
    @Operation(summary = "删除入住管理")
    public AjaxResult remove(@Schema(name = "入住管理ID", requiredMode = Schema.RequiredMode.REQUIRED) @PathVariable Long[] ids)
    {
