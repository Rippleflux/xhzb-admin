...
public class ContractController extends BaseController
{
    ...
    @Log(title = "入住合同", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @Operation(summary = "导出入住合同列表")
    public void export(HttpServletResponse response, Contract contract)
    {
        ...
        util.exportExcel(response, list, "入住合同数据");
    }
    ...
    @GetMapping(value = "/{id}")
    @Operation(summary = "获取入住合同详细信息")
    public AjaxResult getInfo(@Schema(name = "入住合同ID", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Log(title = "入住合同", businessType = BusinessType.INSERT)
    @PostMapping
    @Operation(summary = "新增入住合同")
    ...
    @Log(title = "入住合同", businessType = BusinessType.UPDATE)
    @PutMapping
    @Operation(summary = "修改入住合同")
    ...
    @Log(title = "入住合同", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
    @Operation(summary = "删除入住合同")
    public AjaxResult remove(@Schema(name = "入住合同ID", requiredMode = Schema.RequiredMode.REQUIRED) @PathVariable Long[] ids)
    {
