...
public class AlertRuleController extends BaseController {
     ...
     * 查询报警规则列表
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:list')")
    @GetMapping("/list")
     ...
     * 导出报警规则列表
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:export')")
     ...
     * 获取报警规则详细信息
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增报警规则
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:add')")
     ...
     * 修改报警规则
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:edit')")
     ...
     * 删除报警规则
     */
    @PreAuthorize("@ss.hasPermi('nursing:rule:remove')")
